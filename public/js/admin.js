/*==================== DISABLE BUTTONS FOR REQUIRED FIELDS====================*/
let fields = document.querySelectorAll('.my-form [required]')
...
fields.forEach(field => {
  field.addEventListener('keyup', () => {
    for (const btn of btns) {
        if(btn.id !== "update_submit" && btn.id !==  "update_reset")
        {
          btn.disabled = !fields.every(field => field.value)
        }
   }
  })
})
...
function myFunction() {
  ...
  cardContainer = document.getElementById("myApartments");
